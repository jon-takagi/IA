...
function add_users(link) {
  ...
  textField.name = "project[users_attributes]["+new_id+"][name]";
  textField.id = "project_users_description_" +  new_id;
  hidden_field.name = "project[users_attributes]["+new_id+"][_destroy]";
  hidden_field.type = "hidden";
  hidden_field.id = "project_users__destroy_"+ new_id;
  hidden_field.value = "false";
  removeLink.onclick = function() {
    remove_fields(this);
  };
